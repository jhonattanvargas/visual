        ...
        $(document).ready(function(){
          ...
          $example.npNav('onSelect', function(elem) {
            $('.status').text("selected item: " + (elem.text()));
              ...
              if((elem.text()) == 'Contactenos'){
                      beep.play();
              }
              else if ((elem.text()) != 'Contactenos'){
                      beep.pause();
                      beep.currentTime = 0;
              }

              if((elem.text()) == 'Como llegar'){
                      beep1.play();
              }
              else if ((elem.text()) != 'Como llegar'){
                      beep1.pause();
                      beep1.currentTime = 0;
              }

              if((elem.text()) == 'Como ayudarnos'){
                      beep2.play();
              }
              else if ((elem.text()) != 'Como ayudarnos'){
                      beep2.pause();
                      beep2.currentTime = 0;
              }
                  ...
                  <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                      <audio id="beep2" preload="auto">
                        <source src="<?php echo base_url();?>sounds/Como ayudarnos.mp3" type="audio/mp3" />
                      </audio>
