        ...
        $(document).ready(function(){
          ...
          $example.npNav('onSelect', function(elem) {
            $('.status').text("selected item: " + (elem.text()));
              ...
              else if ((elem.text()) != 'Consejos'){
                      beep.pause();
                      beep.currentTime = 0;
              }

              if((elem.text()) == 'Mensaje a los videntes'){
                      beep1.play();
              }
              else if ((elem.text()) != 'Mensajes a los videntes'){                      
                      beep1.pause();
                      beep1.currentTime = 0;
              }

              if((elem.text()) == 'Mensajes a los no videntes'){
                      beep2.play();
              }
              else if ((elem.text()) != 'Mensajes a los no videntes'){
                      beep2.pause();
                      beep2.currentTime = 0;
              }
