            ...
            <div class="art-content-layout-row">
              <div class="art-layout-cell art-sidebar1">
                <div class="art-vmenublock clearfix">
                  <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                      ...
                      <audio id="beep4" src="<?php echo base_url();?>sounds/Quienes somos texto.mp3" type="audio/mp3" autoplay>
                      </audio>
                ...
                <div class="art-postcontent art-postcontent-0 clearfix">
                  <font face="arial" size=4 color=black>Somos una agrupación que pretende ayudar integralmente a las personas no videntes y con visión 
limitada de Talca y la región del Maule, dándoles: orientación, acceso a ayuda médica acorde con su 
condición de salud, capacitación en técnicas apropiadas para gente para no vidente, recreación y 
esparcimiento. También pretendemos contribuir con la integración de nuestros asociados y a la 
comunidad ni vidente en general a la sociedad generando espacios de educación (como esta página) 
respecto al apropiado trato las personas no videntes y limitados visuales. CENCACYLIV significa: 
“centro de capacitación de los ciegos y limitados visuales”.</font>  
                    </div>
            </div>
          </div>
  </div>
