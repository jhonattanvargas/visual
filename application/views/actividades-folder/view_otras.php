                ...
                <div class="art-vmenublock clearfix">
                  <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                      ...
                      <audio id="beep5" src="<?php echo base_url();?>sounds/Otras texto.mp3" type="audio/mp3" autoplay>
                      </audio>
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix">
                      <font face="arial" size=4 color=black>Aquí también se capacita a los no videntes en el área de AVD (actividades de la vida diaria), que es un 
área para la rehabilitación indispensable para el desenvolvimiento del no vidente en su contexto 
inmediato, ademas le permite tener mayor autonomía y le ayuda en su integración social y familiar. El 
AVD incluye actividades como: comportamiento en la mesa, técnicas de autocuidado y aseo de cocina 
y baño.
También capacitamos a nuestros socios en el área de informática, específicamente en el uso de software
de lenguaje de voz.Ademas se capacita a nuestros socios en la lecto-escritura con el sistema BRAILLE, entre otras 
actividades mas.</font>
                    </div>
            </div>
          </div>
  </div>
