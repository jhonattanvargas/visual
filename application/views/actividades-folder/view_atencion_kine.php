                ...
                <div class="art-vmenublock clearfix">
                  <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                      ...
                      <audio id="beep5" src="<?php echo base_url();?>sounds/Atencion kenesiologica texto.mp3" type="audio/mp3" autoplay>
                      </audio>
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix">
                      <font face="arial" size=4 color=black>Regularmente nuestros socios asisten a tratamientos kinesiológicos, estos les son de inestimable ayuda 
debido a que muchos de ellos tienen una escasa movilidad por no salir o salir con muy poca frecuencia 
de sus casas. Ellos realmente necesitan realizar ejercicios apropiados supervisados por un kinesiologo 
para que sus músculos no terminen atrofiándose, para llevarlos al recinto donde se realiza este 
tratamiento existe un vehículo institucional que cumple esas funciones.</font>
                    </div>
            </div>
          </div>
  </div>
