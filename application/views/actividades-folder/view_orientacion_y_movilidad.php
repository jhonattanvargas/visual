                ...
                <div class="art-vmenublock clearfix">
                  <div class="art-vmenublockcontent">
                    ...
                    <ul class="art-vmenu">
                      ...
                      <audio id="beep5" src="<?php echo base_url();?>sounds/Orientacion texto.mp3" type="audio/mp3" autoplay>
                      </audio>
                    ...
                    <div class="art-postcontent art-postcontent-0 clearfix">
                      <font face="arial" size=4 color=black>En nuestra cede se realizan cada cierto tiempo cursos de movilidad para no videntes ya sea en lugares 
cerrados como en espacios abiertos, son técnicas entregadas por relatores capacitados que permiten a 
los no videntes el desplazarse adecuadamente, obteniendo con ello mas independencia y con ello ser el 
quien decida donde quiere ir no simplemente ser llevado donde otros quieran hacerlo. Junto con esto se 
les capacita en técnicas para desenvolverse apropiadamente en actividades cotidianas.</font>
                    </div>
            </div>
          </div>
  </div>
